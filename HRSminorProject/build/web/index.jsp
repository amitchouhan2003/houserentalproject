...
<head>
    ...
    <title>LeaseEase - Find your dream home</title>
...
<body>
    ...
    <header class="header" data-header>
        ...
        <div class="header-top">
            <div class="container">
                <ul class="header-top-list">
                    <li>
                        <a href="mailto:info@leaseeasee.com" class="header-top-link">
                            <ion-icon name="mail-outline"></ion-icon>
                            <span>info@leaseease.com</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="header-top-link">
                            <ion-icon name="location-outline"></ion-icon>
                            <address>15/A, Bhavani Dham Phase-II, Bhopal</address>
                        </a>
                    </li>
                </ul>
                <div class="wrapper">
                    ...
                    <a href="register.html"><button class="header-top-btn">Add Listing</button></a>
                </div>
            </div>
        </div>
        ...
        <div class="header-bottom">
            <div class="container">
                <a href="#" class="logo">
                    <img src="./favicon.ico" alt="LeaseEase logo" />
                </a>
...
<!--<form action="Searchhouse" method="get">
    <input type="text" name="location" value="SEARCH" />
        ...
        <section class="hero" id="home">
          <div class="container">
            ...
            <figure class="hero-banner">
              <img
                src="./assets/images/modernHouse.jpg"
        ...
        <section class="about" id="about">
          <div class="container">
            ...
            <div class="about-content">
              ...
              <p class="about-text">
                Overall a Good Reputation in Market.
              </p>
            ...
            <ul class="service-list">
              <li>
                <div class="service-card">
                  ...
                  <p class="card-text">
                    over 100+ homes for sale and rent available on the website, we
            ...
            <ul class="property-list has-scrollbar">
              <li>
                <div class="property-card">
                  <figure class="card-banner">
                    ...
                    <div class="banner-actions">
                      <button class="banner-actions-btn">
                        ...
                        <address>LAKEVIEW ,BHOPAL</address>
                      </button>
                  ...
                  <div class="card-content">
                    <div class="card-price"><strong>4Lac</strong>/Month</div>
                    ...
                    <p class="card-text">
                      Beautiful Huge 1 Family House In Heart Of Bhopal. Newly
                      Renovated .
                    </p>
              ...
              <li>
                <div class="property-card">
                  <figure class="card-banner">
                    ...
                    <div class="banner-actions">
                      <button class="banner-actions-btn">
                        ...
                        <address>Arera Colony ,Bhopal</address>
                      </button>
                  ...
                  <div class="card-content">
                    <div class="card-price"><strong>50lac</strong></div>
                    ...
                    <p class="card-text">
                      Beautiful Huge 1 Family House Near Rani Kamlapati Station. Newly
                      Renovated .
                    </p>
              ...
              <li>
                <div class="property-card">
                  ...
                  <div class="card-content">
                    <div class="card-price"><strong>2Lac</strong>/Month</div>
                    ...
                    <p class="card-text">
                      Beautiful Huge 1 Family House. Newly
                      Renovated .
                    </p>
              ...
              <li>
                <div class="property-card">
                  ...
                  <div class="card-content">
                    <div class="card-price"><strong>$34,900</strong>/Month</div>
                ...
                <div class="blog-card">
                  <figure class="card-banner">
                    <img
                      ...
                      alt="The Most Inspiring Interior Design Of 2024"
                      class="w-100"
                    />
                  </figure>
                  ...
                  <div class="blog-content">
                    ...
                    <div class="blog-content-bottom">
                      <div class="publish-date">
                        ...
                        <time datetime="2024-15-04">Apr 15, 2024</time>
                      </div>
      ...
      <div class="footer-top">
        <div class="container">
          <div class="footer-brand">
            <a href="#" class="logo">
              <img src="./favicon.ico" alt="Homeverse logo" />
            </a>
            ...
            <ul class="contact-list">
              <li>
                <a href="#" class="contact-link">
                  ...
                  <address>near Raisen Road, Bhopal, India</address>
                </a>
              </li>
              ...
              <li>
                <a href="tel:+0123456789" class="contact-link">
                  ...
                  <span>+91 9189282892</span>
                </a>
              </li>

              <li>
                <a href="mailto:contact@leaseease.com" class="contact-link">
                  <ion-icon name="mail-outline"></ion-icon>

                  <span>contact@leaseease.com</span>
                </a>
              </li>
            </ul>
